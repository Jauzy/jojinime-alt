        ...
        <Grid container spacing={6}>
            <Grid item xs={12} sm={5} md={3} className={classes.flexColumn}>
                ...
                <Grid container spacing={1} className={classes.marginTop}>
                    <Grid item xs={9}>
                        <Button color='primary' className={classes.fullWidth} variant='contained'>Add to Watch List</Button>
                    </Grid>
                    <Grid item xs={3}>
            ...
            <Grid item xs={12} sm={7} md={9} style={{ display: 'flex', zIndex: 999 }}>
                <div style={{ margin: 'auto 0' }}>
                    ...
                    <div style={{ display: 'flex', flexWrap: 'wrap', margin: '.5em 0' }}>
                        <div style={{ margin: 'auto 0' }}>
                            <StarRatings
                        ...
                        <div style={{ margin: '0 1em' }}>
                            <small>Score</small>
                            <Typography variant='h5'>{details.meanScore / 10}</Typography>
                        </div>
                    </div>
                    <div>
                    ...
                    <Grid container spacing={1} className={classes.marginTop}>
                        ...
                        <Grid item sm={12} md={6}>
                            {details.rankings?.filter(item => item.allTime === true && item.type == 'RATED').map(item => (
                                <Button color='error' className={classes.fullWidth} style={{ backgroundColor: yellow[500] }} variant='contained' startIcon={<StarIcon />}>
                                    #{item.rank} {item.context}
                                </Button>
                            ))}
                        </Grid>
